window.state_data = {
  "state_information_flags": {
    "reports_HAI" : [
      null,
      "Hospitals are not required to track and report information about hospital-acquired infections.",
      "Hospitals are required to track and report information about hospital-acquired infections."
    ],
    "reports_adverse_events" : [
      null,
      "Hospitals are not required to track and report information about adverse events.",
      "Hospitals are required to track and report information about adverse events."
    ],
    "audits_HAI" :  [
      null,
    ...
    "reports_HAI_per_hospital":  [
      null,
      "Infections numbers by hospital are not publicly available.",
      "Infection numbers at each hospital are publicly available."
    ],
    "reports_adverse_events_per_hospital":  [
      null,
      "Adverse events numbers by hospital are not publicly available.",
      "Adverse events numbers at each hospital are publicly available."
    ]
  },
  "states" : [
    ...
    { "state_title": "Arkansas",       "state_abbreviation": "AR", "reports_HAI": 2, "reports_adverse_events": 1, "audits_HAI": 1, "audits_adverse_events": 0, "reports_HAI_per_hospital": 1, "reports_adverse_events_per_hospital": 0, "score": 1 },
    ...
    { "state_title": "Mississippi",    "state_abbreviation": "MS", "reports_HAI": 1, "reports_adverse_events": 1, "audits_HAI": 0, "audits_adverse_events": 0, "reports_HAI_per_hospital": 0, "reports_adverse_events_per_hospital": 0, "score": 0 },
    { "state_title": "Missouri",       "state_abbreviation": "MO", "reports_HAI": 2, "reports_adverse_events": 1, "audits_HAI": 2, "audits_adverse_events": 0, "reports_HAI_per_hospital": 2, "reports_adverse_events_per_hospital": 0, "score": 1 },
