...
(function() {
  ...
  $(function() {
    var $play_button, $progess, $video, build_chapter_markers, chapter, chapter_index, chapters, citations, cue, cues, current_time, duration, goto_chapter, toggle_play, _i, _len;
    ...
    $('header.intro, .introduction').on("click", function() {
      ...
      return setTimeout(function() {
        $('.introduction').remove();
        $('header p').remove();
        return $('header .start-button').remove();
      }, 5000);
    });
        ...
        $(state).on("mouseenter", function(e) {
          ...
          if ($('#us-map').hasClass('expanded')) {
            ...
            for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
              state = _ref3[_k];
              if (("" + state.state_abbreviation + "_1_") === this.id) {
                state_info = state;
              }
            }
            positive = (function() {
    ...
    $('#go-to-credits').on("click", function() {
      return $('#credits').show();
    });
    return $('#close-credits', '#credits').on("click", function(e) {
      e.preventDefault();
      return $('#credits').hide();
    });
  });
